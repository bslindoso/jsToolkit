import Carro from './class/Carro.js';
import Viagem from './class/Viagem.js';
...
calculaCombustivel('PA-STN-OLV-LA-MCZ-LA-OLV-STN-PA', 790, PRECO_GASOLINA, true)
 ...
 */
export default function calculaCombustivel(nomePercurso, kmPercurso, preco_gasolina, comAr) {
